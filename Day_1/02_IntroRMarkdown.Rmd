...
This really gives minimal advantages over Excel, whereas what we really need to publish our research is an accurate record of everything we've done, so we can write up our Materials & Methods section of the paper, and so we can also communicate with our collaborators.
...
Nowadays, we have R Markdown, which allows us to execute code, write simply formatted text with explanations of our approach, and to create figures & tables all in the one document.
This is our recommended way of working for the remainder of the course, so let's start an R Markdown file and get exploring
