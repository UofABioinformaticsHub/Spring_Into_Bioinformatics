...
The object type we're going to use from here is an `EnsDb` object, which is way of storing all of the relevant information from the Ensembl database for our specific genome & annotation release.
