...
If you would like to know more about them, head to http://broadinstitute.github.io/picard/explain-flags.html to see a helpful description, then try clicking on a few combinations to see how the numbers change.

#### Questions
{:.no_toc}

1. *How many reads were mapped to each file and how many had a MAPQ greater than 30?*
2. *How many lines does the head of the `SRR945375.skm.trimmedAligned.sortedByCoord.out.bam` file contain?*
...
![Why not do both??](https://img.buzzfeed.com/buzzfeed-static/static/2015-03/26/19/enhanced/webdr06/original-25942-1427414325-9.jpg)
