...
ALIGNDIR=~/Spring_into_Bioinformatics/Day_2/data/2_alignedData
...
cut -f1,7- ${ALIGNDIR}/featureCounts/user_counts.out | \
    sed 1d > ${ALIGNDIR}/featureCounts/user_genes.out
```
...
| `-o ${ALIGNDIR}/featureCounts/user_counts.out` | The output file |
