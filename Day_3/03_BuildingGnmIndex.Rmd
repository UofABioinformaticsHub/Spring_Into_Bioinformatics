...
For the purposes of this workshop we will perform an alignment of our RAN-seq reads to the genome.
This requires using a tool capable of performing "spliced alignment", tha ability to align the two ends of a read across an intron.
...
With this complete, we are now ready to align the reads from our samples to the indexed genome.